...
public partial class UserControl_Hang : System.Windows.Forms.UserControl
{
    ...
    private void ClearFields()
    {
        txtMaHang.Text = "";
        txtTenHang.Text = "";
        if (!isAdding) txtMaHang.Text = "Id sẽ được tạo tự động";
    }
    ...
    private void btnSua_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Vui lòng chọn một hãng để sửa.", "Chưa chọn", MessageBoxButtons.OK,
        ...
        try
        {
            ...
            else
            {
                ...
                if (existingBranch != null)
                {
                    ...
                    MessageBox.Show("Cập nhật hãng thành công!", "Thông báo", MessageBoxButtons.OK,
    ...
    private void btnXoa_Click(object sender, EventArgs e)
    {
        ...
        if (dgvHang.CurrentRow == null)
        {
            MessageBox.Show("Vui lòng chọn một hãng để xoá.", "Chưa chọn", MessageBoxButtons.OK,
                MessageBoxIcon.Warning);
            return;
        }
        ...
        if (result == DialogResult.Yes)
            ...
            {
                MessageBox.Show(
                    "Không thể xoá hãng này. Đã có 'Figures' được gán cho hãng này. \nBạn phải xoá hoặc thay đổi các 'Figures' đó trước.",
