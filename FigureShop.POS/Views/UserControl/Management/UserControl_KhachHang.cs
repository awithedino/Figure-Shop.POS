...
public partial class UserControl_KhachHang : System.Windows.Forms.UserControl
{
    ...
    private void btnSua_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Vui lòng chọn một khách hàng để sửa.", "Chưa chọn", MessageBoxButtons.OK,
    ...
    private void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                MessageBox.Show("Lỗi: Không tìm thấy vai trò 'Customer' trong database!", "Lỗi hệ thống",
    ...
    private void btnXoa_Click(object sender, EventArgs e)
    {
        ...
        if (MessageBox.Show($"Bạn có chắc chắn muốn xoá khách hàng '{userName}'?", "Xác nhận xoá",
            ...
            try
            {
                ...
                if (userToDelete != null)
                {
                    ...
                    {
                        MessageBox.Show("Không thể xoá khách hàng này vì họ đã có hoá đơn!", "Lỗi",
                            MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
    ...
    private void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        using (var sfd = new SaveFileDialog())
        {
            ...
            sfd.FileName = $"DanhSachKhachHang_{DateTime.Now:yyyyMMdd}.xlsx";
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
                try
                {
                    using (var workbook = new XLWorkbook())
                    {
                        ...
                        // 3. Headers
                        for (var i = 0; i < dgvKhachHang.Columns.Count; i++)
                        {
                        ...
                        // 4. Data Rows
                        for (var i = 0; i < dgvKhachHang.Rows.Count; i++)
                        for (var j = 0; j < dgvKhachHang.Columns.Count; j++)
                        {
