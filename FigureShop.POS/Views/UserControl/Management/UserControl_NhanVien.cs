...
public partial class UserControl_NhanVien : System.Windows.Forms.UserControl
{
    ...
    private void LoadData(IQueryable<User> query = null)
    {
        try
        {
            ...
            if (query == null) query = context.Users.AsQueryable();
    ...
    private void btnSua_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Vui lòng chọn một nhân viên để sửa.", "Chưa chọn", MessageBoxButtons.OK,
    ...
    private void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("Tên, Email, và Mật khẩu (khi thêm mới) không được để trống!", "Lỗi", MessageBoxButtons.OK,
        ...
        {
            MessageBox.Show("Vui lòng chọn Chức vụ (Mã CV) cho nhân viên.", "Lỗi", MessageBoxButtons.OK,
                MessageBoxIcon.Error);
            return;
        }
        ...
        try
        {
            ...
            else
            {
                ...
                if (userToUpdate != null)
                {
                    ...
                    if (txtPassword.Text != "********") userToUpdate.Password = txtPassword.Text; // TODO: Hash this!
    ...
    private void btnXoa_Click(object sender, EventArgs e)
    {
        ...
        if (MessageBox.Show($"Bạn có chắc chắn muốn xoá nhân viên '{userName}'?", "Xác nhận xoá",
            ...
            try
            {
                ...
                if (userToDelete != null)
                {
                    ...
                    {
                        MessageBox.Show("Bạn không thể xoá chính mình!", "Lỗi", MessageBoxButtons.OK,
                            MessageBoxIcon.Error);
                        return;
                    }
    ...
    private void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        using (var sfd = new SaveFileDialog())
        {
            ...
            sfd.FileName = $"DanhSachNhanVien_{DateTime.Now:yyyyMMdd}.xlsx";
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
                try
                {
                    using (var workbook = new XLWorkbook())
                    {
                        ...
                        // Headers
                        for (var i = 0; i < dgvNhanVien.Columns.Count; i++)
                        {
                        ...
                        // Data
                        for (var i = 0; i < dgvNhanVien.Rows.Count; i++)
                        for (var j = 0; j < dgvNhanVien.Columns.Count; j++)
                        {
