        ...
        public static void Initialize(FigureShopDbContext context)
        {
            ...
            try
            {
                ...
                var figures = new List<Figure>
                {
                    ...
                    new Figure { Id = Guid.NewGuid(), Branch = branchAniplex, Category = catScale8, Price = 199.99, Quantity = 5, SalePercent = 20, SaleFrom = DateTime.Now, SaleTo = DateTime.Now.AddDays(14), Description = "1/8 Scale Kyojuro Rengoku. Set your heart ablaze!", Vote = 5.0, Name = "Rengoku Kyojuro 1/8 Scale", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, CreatedBy = adminId, UpdatedBy = adminId },
