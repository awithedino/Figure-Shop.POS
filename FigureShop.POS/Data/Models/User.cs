...
public class User
{
    ...
    [StringLength(10)] public string? Gender { get; set; } // For "Giới tính" (e.g., "Nam", "Nữ")

    public DateTime? Birthday { get; set; } // For "Ngày sinh"

    [StringLength(20)] public string? PhoneNumber { get; set; } // For "SĐT"

    [StringLength(255)] public string? Address { get; set; } // For "Địa chỉ"
