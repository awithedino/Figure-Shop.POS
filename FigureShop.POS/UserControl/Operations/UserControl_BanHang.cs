...
namespace FigureShop.POS
{
    public partial class UserControl_BanHang : System.Windows.Forms.UserControl
    {
        ...
        // === 1. LOAD EVENT (When the screen first opens) ===
        private void UserControl_BanHang_Load(object sender, EventArgs e)
        {
            context = new FigureShopDbContext();
            
            // Get the logged-in user (hard-coded to admin for this example)
        ...
        // === 3. ITEM SELECTION LOGIC (Right Panel) ===
        ...
        {
            // This function calculates the "Thành tiền" for the *single item*
        ...
        // === 4. CART MANAGEMENT LOGIC (Adding/Removing) ===
        ...
        private void UpdateBillTotal()
        {
            ...
            UpdateChange(); // Also update the "Tiền thừa"
        }

        private void txtKhachThanhToan_TextChanged(object sender, EventArgs e)
        {
            UpdateChange(); // Update "Tiền thừa" anytime the user types
        }
        ...
        private void UpdateChange()
        {
            ...
            // Optional: Change color if not enough money
            if (tienThua < 0)
                lblGiaTriTienThua.ForeColor = Color.Red;
            else
                lblGiaTriTienThua.ForeColor = Color.Green; // You might need to change this from Red
        }
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 2. Add all items from the cart to OrderFigures
                ...
                // 5. Start a new bill
                StartNewBill();
                LoadComboBoxes(); // Refresh product list in case stock ran out
            }
            catch (Exception ex)
            {
