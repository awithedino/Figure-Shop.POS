...
using Microsoft.EntityFrameworkCore; // Make sure to import this!
    ...
    public partial class UserControl_SanPham : System.Windows.Forms.UserControl
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                // Optional: Make column headers look better
        ...
        {
            // 1. Get the text from your NEW search box
            var searchText = txtTimKiem.Text.Trim().ToLower();

            // 2. Load all figures if the search box is empty
